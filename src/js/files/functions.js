...
/* Проверка мобильного браузера addTouchClass (==**MW**==) */
...
/* Прокрутка при клике (==**MW**==)*/

// const menuLinks = document.querySelectorAll('.menu__link[data-goto]');   // Ищем класс .menu__link с атрибутом [data-goto]
// if (menuLinks.length > 0) {
// 	menuLinks.forEach(menuLink => {
// 		menuLink.addEventListener("click", onMenuLinkClick);   // Вешем событие "click"  и передаем ее в функцию  onMenuLinkClick
// 	});
// 	function onMenuLinkClick(e) {
// 		const menuLink = e.target;   // Проверка существования объекта на который ссылается атрибут (во избежание ошибок)
// 		if (menuLink.dataset.goto && document.querySelector(menuLink.dataset.goto)) {
// 			const gotoBlock = document.querySelector(menuLink.dataset.goto);
// 			const gotoBlockValue = gotoBlock.getBoundingClientRect().top + pageYOffset - document.querySelector('header').offsetHeight; // Получаем координаты объекта и отнимаем высоту шапки

// 			// Закрываем меню-бургер при выборе раздела
...
// 			// Заставим скролл прокрутиться к нужному месту
// 			window.scrollTo({
// 				top: gotoBlockValue,
// 				behavior: "smooth"
// 			});
// 			e.preventDefault(); // Отключаем работу ссылки href
// 		}
// 	}
// }
